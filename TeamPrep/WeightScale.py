...
class WeightScale:
    ...
    def read_weight_sugar(self):
        ...
        time.sleep(2)
        if weight == 0.0:
            print("      \033[1;32;40m No Sugar needed to brew this batch order. \033[0;0m \n")
        else:
            print("       ****Weight scale is calibrated to \033[1;34;40m0.0\033[0;0m. \n")
            time.sleep(1)
            ...
            for weight_scale in numpy.arange (0.00, weight+0.01, 0.05):
                if weight_scale > 0:
                   ...
                   # time.sleep(2)
                    ...
                    if weight==weight_scale:
                        time.sleep(2)
                        print("      \033[1;32;40m Suger are measured and " + str(weight_scale) + " pounds recieved. \033[0;0m \n")
                    else:
                        #print("       \033[1;31;40m" + str(weight_scale) + "\033[0;0m pound(s) Sugar recieved. \033[1;33;40m" + str(weight-weight_scale) + "\033[0;0m pound(s) left to be dispensed. \n")
                        time.sleep(2)
                        print("       Press the right button to dispense one more packet: ")
