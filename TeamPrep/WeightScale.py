...
class WeightScale:
    ...
    def read_weight_grains(self):
        ...
        print("       To dispense \033[1;33;40m1\033[0;0m packet of \033[1;33;40m1.0\033[0;0m pound All Grain each time on weight scale press the right button : \n")
        print("       Press the right button to dispense one All Grain packet:")
        for weight_scale in numpy.arange(0, weight):
           ...
           # time.sleep(2)
            ...
            if weight==weight_scale:
                ...
                #print("       \033[1;31;40m" + str(weight_scale) + "\033[0;0m pound(s) All Grains recieved. \033[1;33;40m" + str(weight-weight_scale) + "\033[0;0m pound(s) left to be dispensed. \n")
                print("       Press the right button to dispense one more packet: ")
            time.sleep(2)
        return weight_scale
    ...
    def read_weight_hops(self):
        ...
        print("       ****Weight scale is calibrated to \033[1;34;40m0.0\033[0;0m. \n")
        print("       To dispense \033[1;33;40m1\033[0;0m packet of \033[1;33;40m0.5\033[0;0m pound Hops each time on weight scale Press the right button : \n")
        print("       Press the right button to dispense one packet of Hops:")
        for weight_scale in numpy.arange (0, weight):
    ...
    def read_weight_sugar(self):
        ...
        print("       ****Weight scale is calibrated to \033[1;34;40m0.0\033[0;0m. \n")
        print("       To dispense \033[1;33;40m1\033[0;0m packet of \033[1;33;40m0.05\033[0;0m pound Sugar each time on weight scale press the right button : \n")
        print("       Press the right button to dispense one packet of sugar:")
        for weight_scale in numpy.arange (0, weight):
...
class WeightScale:
  ...
  """  
>>>>>>> 173031a0460cf5317f7988764ec010bdfcd125ce
