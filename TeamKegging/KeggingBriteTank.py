...
class KeggingBriteTank:  # Brite Tank
    ...
    def get_status(self):
        ...
        return "Brite Tank ID: {}\n" \
               ...
               "Brite Tank Volume: {}\n" \
               "Brite Tank PSI: {}\n" \
               "Brite Tank Status: {}\n".format(self.bt_id, self.bt_temp, self.bt_max_volume, self.bt_current_volume,
                                                self.bt_psi, self.bt_status)
    ...
    def get_carbonation(self):
        ...
        """
        carbchart = [["Carbchart"],
                     [30, 1.82, 1.92, 2.03, 2.14, 2.23, 2.36, 2.48, 2.6, 2.7, 2.82, 2.93, 3.02, 3.13, 3.24, 3.35, 3.46,
                      3.57, 3.67, 3.78, 3.89, 4, 4.11, 4.22, 4.33, 4.44, 4.66, 4.77, 4.87, 4.98, 4.98],
                     [31, 1.78, 1.88, 2, 2.1, 2.2, 2.31, 2.42, 2.54, 2.65, 2.76, 2.86, 2.96, 3.07, 3.17, 3.28, 3.39,
                      3.5, 3.6, 3.71, 3.82, 3.93, 4.03, 4.14, 4.25, 4.35, 4.46, 4.57, 4.68, 4.78, 4.89],
                     [32, 1.75, 1.85, 1.95, 2.05, 2.15, 2.27, 2.38, 2.48, 2.59, 2.7, 2.8, 2.9, 3, 3.11, 3.21, 3.31,
                      3.42, 3.52, 3.63, 3.73, 3.84, 3.94, 4.04, 4.15, 4.25, 4.36, 4.46, 4.57, 4.67, 4.77],
                     [33, 1.71, 1.81, 1.91, 2.01, 2.1, 2.23, 2.33, 2.43, 2.53, 2.63, 2.74, 2.84, 2.96, 3.06, 3.15, 3.25,
                      3.35, 3.46, 3.56, 3.66, 3.76, 3.87, 3.97, 4.07, 4.18, 4.28, 4.38, 4.48, 4.59, 4.69],
                     [34, 1.68, 1.78, 1.86, 1.97, 2.06, 2.18, 2.28, 2.38, 2.48, 2.58, 2.69, 2.79, 2.90, 3.00, 3.09,
                      3.19, 3.29, 3.39, 3.49, 3.59, 3.69, 3.79, 3.90, 4.00, 4.1, 4.2, 4.3, 4.4, 4.5, 4.60],
                     [35, 1.63, 1.73, 1.83, 1.93, 2.02, 2.14, 2.24, 2.34, 2.43, 2.52, 2.63, 2.73, 2.83, 2.93, 3.02,
                      3.12, 3.22, 3.32, 3.42, 3.52, 3.62, 3.72, 3.82, 3.92, 4.01, 4.11, 4.21, 4.31, 4.41, 4.51],
                     [36, 1.6, 1.69, 1.79, 1.88, 1.98, 2.09, 2.19, 2.29, 2.38, 2.47, 2.57, 2.67, 2.77, 2.86, 2.96, 3.05,
                      3.15, 3.24, 3.34, 3.43, 3.53, 3.63, 3.72, 3.82, 3.92, 4.01, 4.11, 4.21, 4.3, 4.4],
                     [37, 1.55, 1.65, 1.74, 1.84, 1.94, 2.04, 2.14, 2.24, 2.33, 2.42, 2.52, 2.62, 2.71, 2.8, 2.9, 3,
                      3.09, 3.18, 3.27, 3.37, 3.46, 3.56, 3.65, 3.75, 3.84, 3.94, 4.03, 4.13, 4.22, 4.32],
                     [38, 1.52, 1.61, 1.71, 1.8, 1.9, 2, 2.1, 2.2, 2.29, 2.38, 2.48, 2.57, 2.66, 2.75, 2.85, 2.94, 3.03,
                      2.15, 2.21, 2.28, 2.35, 2.42, 2.48, 2.55, 2.62, 2.69, 2.75, 2.82, 2.88, 2.95, 3.02],
                     [59, 1.02, 1.09, 1.16, 1.22, 1.29, 1.36, 1.43, 1.49, 1.56, 1.64, 1.71, 1.77, 1.84, 1.91, 1.98,
                      2.04, 2.11, 2.17, 2.24, 2.31, 2.38, 2.43, 2.5, 2.57, 2.64, 2.7, 2.77, 2.84, 2.91, 2.97],
                     [60, 1.01, 1.08, 1.15, 1.21, 1.28, 1.34, 1.41, 1.47, 1.54, 1.62, 1.62, 1.75, 1.82, 1.88, 1.95,
                      2.01, 2.08, 2.14, 2.21, 2.27, 2.34, 2.4, 2.47, 2.53, 2.6, 2.66, 2.73, 2.79, 2.86, 2.92],
                     [61, 0.99, 1.05, 1.12, 1.18, 1.24, 1.31, 1.37, 1.44, 1.5, 1.57, 1.63, 1.69, 1.76, 1.82, 1.89, 1.95,
                      2.02, 2.08, 2.14, 2.21, 2.27, 2.34, 2.4, 2.47, 2.53, 2.59, 2.66, 2.72, 2.79, 2.85],
                     [62, 0.96, 1.02, 1.09, 1.15, 1.21, 1.27, 1.34, 1.4, 1.46, 1.52, 1.59, 1.65, 1.71, 1.78, 1.84, 1.9,
                      1.97, 2.03, 2.09, 2.15, 2.22, 2.28, 2.34, 2.41, 2.47, 2.53, 2.59, 2.66, 2.72, 2.78],
                     [63, 0.93, 0.99, 1.06, 1.12, 1.18, 1.24, 1.3, 1.36, 1.42, 1.49, 1.55, 1.61, 1.67, 1.73, 1.79, 1.85,
                      1.92, 1.98, 2.04, 2.1, 2.16, 2.22, 2.28, 2.35, 2.41, 2.47, 2.53, 2.59, 2.65, 2.71],
                     [64, 0.91, 0.97, 1.03, 1.09, 1.15, 1.21, 1.27, 1.33, 1.39, 1.45, 1.51, 1.57, 1.63, 1.69, 1.75,
                      1.81, 1.87, 1.93, 1.99, 2.05, 2.11, 2.17, 2.23, 2.29, 2.35, 2.41, 2.47, 2.52, 2.58, 2.64],
                     [65, 0.88, 0.94, 1, 1.06, 1.11, 1.17, 1.23, 1.29, 1.35, 1.41, 1.46, 1.52, 1.58, 1.64, 1.7, 1.76,
                      1.82, 1.87, 1.93, 1.99, 2.05, 2.11, 2.17, 2.23, 2.28, 2.34, 2.4, 2.46, 2.52, 2.58]]
    ...
    def print_carb_status(self):
        ...
        """
        print("Tank Temperature: " + str(self.bt_temp) + " degrees Fahrenheit || Tank Pressure: " + str(
            self.bt_psi) + " PSI || Carbonation: " + str(self.get_carbonation()) + " vols")
    ...
    def bt_temp_control(self):
        ...
        try:
            ...
            if self.bt_temp < 30:
                print(
                    "Tank temperature is less than 30 degrees Fahrenheit. Please raise tank temperature above 30 degrees Fahrenheit.")
                self.temp_choice()
            elif self.bt_temp >= 66:
                print(
                    "Tank temperature is greater than 66 degrees Fahrenheit. Please lower tank temperature below 66 degrees Fahrenheit.")
                self.temp_choice()
            elif 33 <= self.bt_temp < 66:
                print(
                    "The tank temperature is in detectable range but not between the ideal range of 30 to 32 degrees Fahrenheit.")
                self.temp_choice()
